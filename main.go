...
import (
	...
	"github.com/berry-data/BerryMiner/contracts1"
	"github.com/berry-data/BerryMiner/db"
	"github.com/berry-data/BerryMiner/ops"
...
const versionMessage = `
	...
	Github:  https://github.com/berry-data/BerryMiner
`

func App() *cli.Cli {

	app := cli.App("BerryMiner", "The berrydata.co official miner")
